...
item1 = Item(sport=sport1, name='Whitewater Paddle',
             description='A paddle used to propel and maneuver whitewater kayaks. Primary use is for whitewater',
...
item2 = Item(sport=sport1, name='Whitewater Sprayskirt',
             description='A waterproof cover for a whitewater kayak, that prevents water from entering the boat while still allowing the paddler to maneuver', picture='/static/img/whitewaterkayakskirt.jpg')

session.add(item2)
session.commit()

item3 = Item(sport=sport1, name='Whitewater Kayak',
             description='A kayak meant to be used in whitewater', picture='/static/img/whitewaterkayak.jpg')
...
item4 = Item(sport=sport2, name='Climbing Rope',
             description='Rope used for climbing', picture='/static/img/climbingrope.jpg')

session.add(item4)
session.commit()

item5 = Item(sport=sport2, name='Climbing Harness',
             description='Used to secure climber to rope', picture='/static/img/climbingharness.jpg')

session.add(item5)
session.commit()

item6 = Item(sport=sport2, name='Climbing Shoes',
             description='Shoes used for climbing', picture='/static/img/climbingshoes.jpg')
